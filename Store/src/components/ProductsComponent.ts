        ...
        <div class="product-card card">
            ...
            <div class="product-card__body  card-body">
                ...
                <div class="product-card__price-and-color container d-flex justify-content-between align-items-center">
                    <h6 class="product-card__price card-title"><i class="bi bi-currency-exchange"></i> ${obj.price}$</h6>
                    <div class="product-card__color" style="background: ${obj.color}"></div>
                </div>
                
                <p class="card-text my-0"><i class="bi bi-calendar-week"></i> ${obj.year}</p>
                <p class="card-text my-0"><i class="bi bi-building"></i> ${obj.company}</p>
                <p class="card-text my-0"><i class="bi bi-camera"></i> ${obj.camResolution}</p>
            ...
            <span class="text-muted"> On storage:${obj.onStorage} </span>
        </div>
        `;
    }
}
